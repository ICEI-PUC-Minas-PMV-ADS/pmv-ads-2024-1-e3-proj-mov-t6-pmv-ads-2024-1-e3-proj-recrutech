...
namespace Recrutech_api.Migrations
{
    ...
    [Migration("20240413030645_new-t2")]
    partial class newt2
    {
            ...
            modelBuilder.Entity("UserVacancy", b =>
                {
                    ...
                    b.Property<int>("VacanciesOwnerId")
                        .HasColumnType("integer");

                    b.HasKey("UsersId", "VacanciesOwnerId");

                    b.HasIndex("VacanciesOwnerId");
            ...
            modelBuilder.Entity("UserVacancy", b =>
                {
                    ...
                    b.HasOne("Recrutech_api.Model.Vacancy", null)
                        .WithMany()
                        .HasForeignKey("VacanciesOwnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
